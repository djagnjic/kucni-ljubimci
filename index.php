    ...
    <main>
        <section class="ljubimci">
            ...
            <div class="ljubimci-container">
                <?php
                $query = "SELECT * FROM vijest WHERE arhiva=0 AND kategorija='ljubimci' LIMIT 3";
        ...
        <section class="ljubimci">
            ...
            <div class="ljubimci-container">
                <?php
                $query = "SELECT * FROM vijest WHERE arhiva=0 AND kategorija='savjeti' LIMIT 3";
                $result = mysqli_query($dbc, $query);
                $uppath = "uploads/";
        ...
        <section class="ljubimci">
            <h2>Priče i iskustva</h2>

            <div class="ljubimci-container">
                <?php
                $query = "SELECT * FROM vijest WHERE arhiva=0 AND kategorija='iskustva' LIMIT 3";
                $result = mysqli_query($dbc, $query);
                $uppath = "uploads/";
